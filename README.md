...
Dieses Projekt demonstriert einen ingenieurmäßigen Ansatz zur Qualitätssicherung eines Python-Prototyps. Es wurde im Rahmen der Portfolioprüfung Teil III im Modul Software Engineering II an der Hochschule Bremen entwickelt.
...
**Automatisierter Testung** mit `pytest`.
**Messung der Testabdeckung** mit `pytest-cov`.
